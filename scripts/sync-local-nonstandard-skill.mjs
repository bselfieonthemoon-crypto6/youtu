...
const migration = 'supabase/migrations/20260915000002_nonstandard_image_size_skill.sql';
...
query(`BEGIN; SELECT pg_advisory_xact_lock(20260915,2); ${sql}
...
INSERT INTO supabase_migrations.schema_migrations(version,name) VALUES ('20260915000002','nonstandard_image_size_skill') ON CONFLICT(version) DO NOTHING; COMMIT;`);
