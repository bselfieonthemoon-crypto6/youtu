...
query(`BEGIN; SELECT pg_advisory_xact_lock(20260915,3); ${sql}
...
INSERT INTO supabase_migrations.schema_migrations(version,name) VALUES ('20260915000003','semantic_layer_skill') ON CONFLICT(version) DO NOTHING; COMMIT;`);
