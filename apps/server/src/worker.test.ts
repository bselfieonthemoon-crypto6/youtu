...
describe("worker claim gate", () => {
  ...
  it.each([
    ...
    ["a locally repainted frame of the wrong shape", "local_repaint_geometry_mismatch", "generated 3:2 instead of 1:1", "job-repaint-shape",
      () => Object.assign(new Error("generated 3:2 instead of 1:1"), { code: "local_repaint_geometry_mismatch" })],
    ["an outpainted frame of the wrong shape", "outpaint_geometry_mismatch", "generated 1:1 instead of 16:9", "job-outpaint-shape",
      () => Object.assign(new Error("generated 1:1 instead of 16:9"), { code: "outpaint_geometry_mismatch" })],
