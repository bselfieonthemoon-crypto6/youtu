...
const dir='../../artifacts/overflow-pan-20260915/';await mkdir(dir,{recursive:true});
...
if(!f.canvasId){const p=(await call('/api/projects','POST',{name:'QA 画板遮罩平移',description:'遮罩事件独立验收'})).project;f.canvasId=p.primaryCanvas.id;await writeFile(dir+'fixture.json',JSON.stringify(f));}
